    ...
    function BitBucketServerAPI(repoMetadata, repoCredentials) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        path = "rest/api/1.0/" + repoSlug + "/pull-requests?at=refs/heads/" + branch + "&withProperties=false&withAttributes=false&start=" + nextPageStart;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        path = this.getPRBasePath() + "/commits?start=" + nextPageStart;
                        return [4 /*yield*/, this.get(path)];
                    case 2:
                        res = _a.sent();
                        throwIfNotOk(res);
        ...
        this.getStructuredDiffForFile = function (base, head, filename) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repoSlug = this.repoMetadata.repoSlug;
                        path = "rest/api/1.0/" + repoSlug + "/compare/diff/" + filename + "?withComments=false&from=" + head + "&to=" + base;
                        return [4 /*yield*/, this.get(path)];
                    case 1:
                        res = _a.sent();
                        throwIfNotOk(res);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        path = this.getPRBasePath() + "/changes?start=" + nextPageStart;
                        return [4 /*yield*/, this.get(path)];
                    case 2:
                        res = _a.sent();
                        throwIfNotOk(res);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            path = this.getPRBasePath() + "/activities?fromType=" + type + "&start=" + nextPageStart;
                            return [4 /*yield*/, this.get(path)];
                        case 2:
                            res = _a.sent();
                            throwIfNotOk(res);
        ...
        this.getFileContents = function (filePath, repoSlug, refspec) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "rest/api/1.0/" + repoSlug + "/" + ("raw/" + filePath) + ("?at=" + refspec);
        ...
        this.api = function (path, headers, body, method, suppressErrors) {
            ...
            if (_this.repoCredentials.token) {
                headers["Authorization"] = "Bearer " + _this.repoCredentials.token;
            }
