...
var BitBucketCloudAPI = /** @class */ (function () {
    function BitBucketCloudAPI(repoMetadata, credentials) {
        ...
        this.d = debug_1.debug("BitBucketCloudAPI");
        ...
        this.getPullRequestsFromBranch = function (branch) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nextPageURL = encodeURI(this.getBaseRepoURL() + "/pullrequests?q=source.branch.name = \"" + branch + "\"");
                        values = [];
                        _a.label = 1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        values = [];
                        nextPageURL = this.getPRURL() + "/commits";
                        _a.label = 1;
                    case 1: return [4 /*yield*/, this.get(nextPageURL)];
                    case 2:
                        res = _a.sent();
        ...
        this.getPullRequestDiff = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(this.getPRURL() + "/diff")];
                    case 1:
                        res = _a.sent();
        ...
        this.getPullRequestComments = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        values = [];
                        nextPageURL = this.getPRURL() + "/comments?q=deleted=false";
                        _a.label = 1;
                    case 1: return [4 /*yield*/, this.get(nextPageURL)];
                    case 2:
                        res = _a.sent();
        ...
        this.getPullRequestActivities = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        values = [];
                        nextPageURL = this.getPRURL() + "/activity";
                        _a.label = 1;
                    case 1: return [4 /*yield*/, this.get(nextPageURL)];
                    case 2:
                        res = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        url = this.baseURL + "/repositories/" + repoSlug + "/src/" + ref + "/" + filePath;
        ...
        this.getDangerComments = function (dangerID) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        comments = _a.sent();
                        dangerIDMessage = bitbucketCloudTemplate_1.dangerIDToString(dangerID);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        comments = _a.sent();
                        dangerIDMessage = bitbucketCloudTemplate_1.dangerIDToString(dangerID);
                        return [2 /*return*/, comments.filter(function (comment) { return comment.inline; }).map(function (comment) { return ({
        ...
        this.postBuildStatus = function (commitId, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.post(this.getBaseRepoURL() + "/commit/" + commitId + "/statuses/build", {}, payload)];
                    case 1:
                        res = _a.sent();
                        throwIfNotOk(res);
                        return [4 /*yield*/, res.json()];
        ...
        this.deleteComment = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = this.getPRURL() + "/comments/" + id;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            headers["Authorization"] = "Basic " + new Buffer(this.credentials.username + ":" + this.credentials.password).toString("base64");
                            return [3 /*break*/, 6];
                        case 1:
                            if (!(this.accessToken == null)) return [3 /*break*/, 5];
                            this.d("accessToken not found, trying to get from " + this.oauthURL + ".");
                            params = new url_1.URLSearchParams();
                            params.append("grant_type", "client_credentials");
                            return [4 /*yield*/, this.performAPI(this.oauthURL, __assign({}, headers, { Authorization: "Basic " + new Buffer(this.credentials.oauthKey + ":" + this.credentials.oauthSecret).toString("base64"), "Content-Type": "application/x-www-form-urlencoded" }), params, "POST", suppressErrors)];
                        case 2:
                            authResponse = _a.sent();
                            if (!authResponse.ok) return [3 /*break*/, 4];
                        ...
                        case 5:
                            ...
                            _a.label = 6;
                        case 6:
                            if (!(this.uuid == null)) return [3 /*break*/, 10];
                            this.d("UUID not found, trying to get from " + this.baseURL + "/user");
                            return [4 /*yield*/, this.performAPI(this.baseURL + "/user", headers, null, "GET", suppressErrors)];
                        case 7:
                            profileResponse = _a.sent();
                            if (!profileResponse.ok) return [3 /*break*/, 9];
                        ...
                        case 8:
                            ...
                            return [3 /*break*/, 10];
                        case 9:
                            message = profileResponse.status + " - " + profileResponse.statusText;
                        ...
                        case 10: return [2 /*return*/, this.performAPI(url, headers, body, method, suppressErrors)];
                    }
                });
            });
        };
