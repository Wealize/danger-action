...
var fixtures = path_1.resolve(__dirname, "..", "..", "_tests", "fixtures");
/** Returns a fixture. */
var loadFixture = function (path) {
    return fs_1.readFileSync(path_1.join(fixtures, path), {})
        .toString()
        .replace(/\r/g, "");
};
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    _a = api;
                    return [4 /*yield*/, exports.requestWithFixturedJSON(pullRequestInfoFilename)];
                case 1:
                    _a.getPullRequestInfo = _f.sent();
                    _b = api;
                    return [4 /*yield*/, exports.requestWithFixturedJSON("bitbucket_cloud_comments.json")];
                case 2:
                    _b.getPullRequestComments = _f.sent();
                    _c = api;
                    return [4 /*yield*/, exports.requestWithFixturedJSON("bitbucket_cloud_commits.json")];
                case 3:
                    _c.getPullRequestCommits = _f.sent();
                    _d = api;
                    return [4 /*yield*/, exports.requestWithFixturedJSON("bitbucket_cloud_activities.json")];
                case 4:
                ...
                case 7:
                    bbcDSL = _f.sent();
                    gitDSL = BitBucketCloudGit_2.bitBucketCloudGitDSL(bbcDSL, gitJSONDSL, bbc.api);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, dslGenerator_1.jsonDSLGenerator(bbc, fakeSource, {})];
                case 1:
                    dataSent = _a.sent();
                    dataSent.settings.github.accessToken = "12345";
                    fs_1.writeFileSync(path_1.join(fixtures, "bbc-dsl-input.json"), JSON.stringify(dataSent, null, "  "), "utf8");
                    return [2 /*return*/];
            }
        });
    }); });
...
describe("bitBucketCloudRawAndDateToGitCommitAuthor", function () {
    ...
    it("should convert name doesn't contain space correctly", function () {
        ...
        expect(BitBucketCloudGit_1.bitBucketCloudRawAndDateToGitCommitAuthor(raw, date)).toEqual({
            name: "Foo",
            email: "foo@bar.com",
            date: date,
        });
