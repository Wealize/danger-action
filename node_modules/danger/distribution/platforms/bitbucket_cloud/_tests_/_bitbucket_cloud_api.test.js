...
describe("API testing - BitBucket Cloud", function () {
    ...
    it("getPullRequestsFromBranch", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(api.fetch).toHaveBeenCalledWith("https://api.bitbucket.org/2.0/repositories/foo/bar/" + encodeURI("pullrequests?q=source.branch.name = \"branch\""), { method: "GET", body: null, headers: expectedJSONHeaders }, undefined);
                ...
                case 0:
                    ...
                    jsonResult = function () { return ({
                        ...
                        values: [
                            {
                                content: {
                                    raw: "FAIL! danger-id-1; " + bitbucketCloudTemplate_1.dangerSignaturePostfix({}, commitID),
                                },
                                user: {
                                    display_name: "name",
                                    uuid: "{1234-1234-1234-1234}",
                    ...
                    return [4 /*yield*/, api.getDangerComments("1")];
                case 1:
                    result = _a.sent();
                    expect(api.fetch).toHaveBeenCalledWith("https://api.bitbucket.org/2.0/repositories/foo/bar/pullrequests/1/comments?q=deleted=false", { method: "GET", body: null, headers: expectedJSONHeaders }, undefined);
    ...
    it("should fetch uuid if not exists given username", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should fetch uuid if not exists given oauth key", function () { return __awaiter(_this, void 0, void 0, function () {
        var requestNo, fetch, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("should fetch uuid if not exists given accessToken", function () { return __awaiter(_this, void 0, void 0, function () {
        var requestNo, fetch, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("shouldn't fetch uuid if uuid exists (from api calling)", function () { return __awaiter(_this, void 0, void 0, function () {
        var fetch, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
