...
import { BitBucketCloudPRDSL, BitBucketCloudCommit, BitBucketCloudPRActivity, BitBucketCloudPRComment } from "../../dsl/BitBucketCloudDSL";
...
export declare class BitBucketCloudAPI {
    ...
    getDangerComments: (dangerID: string) => Promise<BitBucketCloudPRComment[]>;
