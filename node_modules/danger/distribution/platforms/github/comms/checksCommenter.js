...
exports.GitHubChecksCommenter = function (api) {
    ...
    return {
        platformResultsPreMapper: function (results, options, ciCommitHash) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        pr = _a.sent();
                        return [4 /*yield*/, resultsToCheck_1.resultsToCheck(results, options, pr, api.getExternalAPI(), ciCommitHash)];
                    case 4:
                        checkData = _a.sent();
                        _a.label = 5;
                    case 5:
