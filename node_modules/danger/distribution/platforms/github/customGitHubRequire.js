 ...
 */
exports.dangerRepresentationForPath = function (value) {
    var hasManySlashes = value.split("/").length > 2;
    var _a = hasManySlashes
        ? value.split("@")[0].split("/")
        : [undefined, undefined].concat(value.split("@")[0].split("/")), owner = _a[0], repo = _a[1], pathComponents = _a.slice(2);
    return {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    URLPath = "repos/" + repoSlug + "/contents/" + path + refString;
                    url = containsBase ? URLPath : baseUrl + "/" + URLPath;
...
exports.shouldUseGitHubOverride = function (request, parent) {
...
exports.customGitHubResolveRequest = function (token) { return function (request, parent) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                debug_1.default("Grabbing relative import \"" + request + "\" to " + prefixLessParent + ".");
            ...
            case 2:
                ...
                if (dangerfileContent) {
                    newPerilFileReference = "" + exports.dangerPrefix + newReferenceString;
            ...
            throw new Error("Could not find '" + request + "' as a relative import from " + prefixLessParent + ". Does " + localPath + " exist in the repo?");
        }
    });
}); }; };
