...
var getRuntimeCISource = function (app) { return __awaiter(_this, void 0, void 0, function () {
    var source;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get_ci_source_1.getCISource(process.env, app.externalCiProvider || undefined)];
            case 1:
                source = _a.sent();
                if (!source) {
                ...
                if (!(source && source.setup)) return [3 /*break*/, 3];
                return [4 /*yield*/, source.setup()];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [2 /*return*/, source];
        }
    });
}); };
exports.default = getRuntimeCISource;
//# sourceMappingURL=getRuntimeCISource.js.map