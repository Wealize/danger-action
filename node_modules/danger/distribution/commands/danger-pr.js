...
var log = console.log;
var gitLabApiCredentials = GitLabAPI_1.getGitLabAPICredentialsFromEnv(process.env);
commander_1.default
    ...
    if (!process.env["DANGER_GITHUB_API_TOKEN"] &&
        ...
        log("");
        log("     You don't have a DANGER_GITHUB_API_TOKEN/DANGER_GITLAB_API_TOKEN/DANGER_BITBUCKETCLOUD_OAUTH_KEY/DANGER_BITBUCKETCLOUD_USERNAME set up, this is optional, but TBH, you want to do this.");
