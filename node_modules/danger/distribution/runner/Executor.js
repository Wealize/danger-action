...
var Executor = /** @class */ (function () {
    ...
    Executor.prototype.handleResultsPostingToPlatform = function (originalResults, git) {
        return __awaiter(this, void 0, void 0, function () {
            var results, fails, warnings, messages, markdowns, failureCount, messageCount, dangerID, failed, issueURL, previousComments, _i, previousComments_1, comment, s, are, mergedResults, previousComments, inline, inlineLeftovers, commitID, comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 11:
                        ...
                        _a.label = 12;
                    case 12:
                        if (!DangerResults_1.isEmptyResults(mergedResults)) return [3 /*break*/, 13];
                    ...
                    case 14:
                        ...
                        _a.label = 15;
                    case 15:
                        if (!!this.options.noPublishCheck) return [3 /*break*/, 17];
                        return [4 /*yield*/, this.updatePrStatus(!failed, issueURL, results, dangerID)];
                    case 16:
                        _a.sent();
                        _a.label = 17;
                    case 17:
                        if (!this.options.verbose) return [3 /*break*/, 19];
                        return [4 /*yield*/, this.handleResultsPostingToSTDOUT(results)];
                    case 18:
                        _a.sent();
                        _a.label = 19;
